...
const showImages = (images) => {
  ...
  images.forEach(image => {
    ...
    div.className = 'col-sm-6 col-md-4 col-lg-4 img-item px-2 mb-3';
    div.innerHTML = ` <img class="img-fluid card-img-top w-100 h-100" onclick=selectItem(event,"${image.webformatURL}") src="${image.webformatURL}" alt="${image.tags}">`;
